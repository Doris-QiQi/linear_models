...
changing reference categories won’t change “fit” or statistical significance

but can affect ease of interpretation.
...
#### `broom::glance` produce a tibble of statistics
```{r}
fit %>% 
  broom::glance()
```

#### `broom::tidy` produce a tibble for each term in the regression
